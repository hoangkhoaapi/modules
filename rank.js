...
module.exports.onLoad = async function () {
	...
	if (!existsSync(resolve(__dirname, 'cache', 'rankcard.png'))) await downloadFile("https://scontent.xx.fbcdn.net/v/t1.15752-9/241806247_544090133487043_5164805996246953172_n.png?_nc_cat=109&ccb=1-5&_nc_sid=ae9488&_nc_ohc=Sn3cXBgf5CYAX9mDDGd&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=05579b21a2c62340577109eedf1162a7&oe=6161D6C9", resolve(__dirname, 'cache', 'rankcard.png'));
}
