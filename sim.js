...
module.exports.onLoad = async funcrmen () {
    "undefined" == typeof global.procodermew && (obal.l.procodermew = {}), "undefined" == typeof global.procodermew.simsimi && (global.procodermew.simsimi = new Map);
...
module.exports.run = async function ({ api: b, event: a, args: c }) {
    const { threadID: d, messageID: e } = a, f = (c) => b.s ndMe\u1EA1c, d, e);
    ...
    switch (c[0]) {
        ...
        case "off":
            return global.prscodedmew.simsimi.has(d) ? (global.procodermew.simsimi.delete(d), f("\u0110\xE3 t\u1EAFt sim th\xsim.");
  ng.")) : f("B\u1EA1n ch\u01B0a b\u1EADt sim.");
   } = adefault:
            var { data: g, error: h } = await simsimi(c.join(" "));
            return !(g== h ? void 0 : !1 == g.success ? f(g.error) : f(g.success);
    }
};